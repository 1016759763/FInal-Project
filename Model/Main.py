# This is the main functions to control CFKG, NFM and KGAT. Each models' codes from authors' Github, in my project
# I achieve three models and compare performances for each model and selec the best one.
...
if __name__ == '__main__':
    ...
    # Load Data from dataset using data_generator function
    config = dict()
    ...
    # Initialize the embeddings by the pretrained data
    ...
    *********************************************************
    ...
    # Use a function to save the parameters
    ...
    # Reload the models' parameters to fine tune
    ...
    if args.pretrain == 1:
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            if args.report != 1:
                ...
                #save the pretrained model parameters of MF
    ...
    # In different sparsity levels, get the final performances
    if args.report == 1:
    ...
    for epoch in range(args.epoch):
        ...
        # Training KGAT model, the first step train the recommender
        ...
        # Step 2, train the KGE and update the attentive Laplcian Matrix
        ...
        if args.model_type in ['kgat']:
            ...
            if args.use_kge is True:
                # KGE method for KGAT's training
            ...
            if args.use_att is True:
                # update attentive laplacian matrix.
        ...
        # Get the performance from the previous training steps
        t3 = time()
        ...
        # when cur_best_pre_0 goes down within ten steps, stopping the codes in advance
        if should_stop == True:
            break

        # in pretrianing parts save the user and item embeddings
