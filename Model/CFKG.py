#  the models' codes parts from Dr He's project.
# tensorflow == 1.2.1
...
class CFKG(object):
    ...
    def _parse_args(self, data_config, pretrain_data, args):
        ...
        self.lr = args.lr
        # previous seeting CF part
        self.emb_dim = args.embed_size
        self.batch_size = args.batch_size

        # prebious setting KG's part
    ...
    def _build_inputs(self):
        ...
        # dropout:information dropout, the nodes dropout
    ...
    def _get_kg_inference(self, h, r, pos_t, neg_t):
        ...
        # head and tail entity embeddings part equals batch size times embedding dimension
        ...
        # relation combining equals batch size times KGE dimensions
